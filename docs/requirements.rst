...
===============================================
Requirements for spSounds
===============================================

This is the software requirements file for spSounds, part of the
SNAPPY project. The requirements listed below should define
what spSounds does. Each requirement can be matched to a unit test that
